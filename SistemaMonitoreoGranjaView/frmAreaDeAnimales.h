...
#include "frmComederos.h"
#include "frmIncubadoras.h"
#include "frmAlimentos.h"
...
namespace SistemaMonitoreoGranjaView {
	...
	/// <summary>
	/// Resumen de frmAreaDeAnimales
	/// </summary>
	public ref class frmAreaDeAnimales : public System::Windows::Forms::Form
	{
	public:
		frmAreaDeAnimales(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmAreaDeAnimales::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmAreaDeAnimales::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &frmAreaDeAnimales::button3_Click);
			// 
			// tabControl1
			// 
			...
			this->Name = L"frmAreaDeAnimales";
			this->Text = L"frmAreaDeAnimales";
			this->Load += gcnew System::EventHandler(this, &frmAreaDeAnimales::frmAreaDeAnimales_Load);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		frmIncubadoras^ ventanaIncubadoras = gcnew frmIncubadoras();
		ventanaIncubadoras->Show();
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		frmComederos^ ventanaComederos = gcnew frmComederos();
		ventanaComederos->Show();
	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		frmAlimentos^ ventanaAlimentos = gcnew frmAlimentos();
		ventanaAlimentos->Show();
		/*frmMantAreaDeAnimales^ ventanaAlimentos = gcnew frmMantAreaDeAnimales();
		ventanaAlimentos->Show();*/
	}
	private: System::Void frmAreaDeAnimales_Load(System::Object^ sender, System::EventArgs^ e) {
	}
};
}
